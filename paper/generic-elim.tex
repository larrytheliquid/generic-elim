...
an argument. To access an argument of some constructor, you
...
For example, below are the specialized constructors
...
To introduce the vector, apply {\tt init} to a tuple
starting with the tag of the constructor, followed by all of its
