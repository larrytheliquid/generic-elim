...
In the introduction we presented sugared type signature of
...
{\tt α}. The indutive hypotheses for each constructor are simililarly
...
described types. The structure of descriptions is crawled, ignoring
any dependent arguments and requiring the motive applied to subterm
indices for recursive arguments.
