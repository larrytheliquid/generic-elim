...
be eliminated with the the single elimination rule for descriptions -- called {\tt ind} --
...
parameterized by a description.  In a sense we derive the datatype axioms 
of languages like Coq, Agda within a simple and sound system.
...
all describle within the theory.
