...
standardizing understanding of writing IDSL's as generic wrapper
...
The goal of this section is to learn how to define the generic wrapper
function {\tt bits}. The generic wrapper function {\tt bits} is
defined in terms of the low-level binary to decimal converter
{\tt decimal}. The wrapper {\tt bits} is an IDSL for creating
user-friendly converters from a binary string of some length to a
decimal value, such that we can write examples like the following.
