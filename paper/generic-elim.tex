...
datatypes defined using descriptions. In some sense, this is the
...
Ornaments \citep{mcbride2010ornamental} allow you to new
description-based datatypes in terms of their relationship with
existing datatypes, and freely convert between the two. Free
conversion between data means that you can reuse functions defined
...
\citet{dagand2012transporting} also has done work on using ornaments
to define new functions based on old ones such that there
relationship is freely captured, extending the idea of defining new
datatypes from old ones such that there relationship is freely
captured. This work uses an alternative, more expressive, description
...
metatheory of this work, Dagand defines and proves soundness as the statement
...
eliminator-based definitions to {\tt ind}-based should be very similar
to what our work is doing. The difference is that in our work this
...
equivalence to eliminators defined at the level of metatheory.
