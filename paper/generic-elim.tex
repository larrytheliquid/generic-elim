...
ability to perform generic programming~[TODO cite levitation, dagand thesis, ornaments]
...
For example, \citep{TODO} translates
{\sc Coq}~\citep{TODO} {\tt Fix}-based definitions into eliminators,
and \citep{TODO} translates dependent pattern matching into
...
in this paper we use the encoding by McBride~\citep{TODO}. The related
...
One alternative {\tt Desc} definition is Dagand's~\citep{TODO}, which
...
their isomorphic dependent pair equivalents. Foveran~\citep{TODO} is
